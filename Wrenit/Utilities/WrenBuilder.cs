...
namespace Wrenit.Utilities
{
	public static class WrenBuilder
	{
		...
		public static WrenModule Build<T>()
		{
			...
			AppendWrenImports(moduleType.GetAttributes<WrenImportAttribute>(), sb);
		...
		private static void AppendWrenImports(List<WrenImportAttribute> importAttributes, StringBuilder sb)
		{
